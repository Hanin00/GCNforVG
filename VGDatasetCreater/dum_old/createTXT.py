...
# xlxspath1 = '../data/image_regions.xlsx'
# xlxspath2 = '../data/image_regions5000.xlsx'
# xlxspath3 = '../data/image_regions10000.xlsx'
#
# ut.jsontoxml(1000, jsonpath, xlxspath1,)
# ut.jsontoxml(5000, jsonpath, xlxspath2,)
# ut.jsontoxml(10000, jsonpath, xlxspath3,)
...
# #xlxspath = './data/image_regions.xlsx'
#
# testFile = open('./data/cluster.txt', 'r')  # 'r' read의 약자, 'rb' read binary 약자 (그림같은 이미`지 파일 읽을때)
