...
for i in tqdm(range(imgCnt)):
    ...
    idIdxDict = {name: value for name, value in zip(objIdList, newObjIdList)}
    idNameDict = {name: value for name, value in zip(objIdList, attrNameList)}    #name attr  추가를 위한 코드
